...
async function main() {
  const plats = {
    ...
    'Roulés de Courgettes au Fromage de Chèvre':{ type_lunch:'dîner',taste:'salée',number_people:'4'},
    'Club Sandwich au Poulet et au Bacon':{ type_lunch:'déjeuner',taste:'salée',number_people:'4'},
    'Gnocchis à la Sauce Tomate et Basilic':{ type_lunch:'dîner',taste:'salée',number_people:'4'},
    'Chili Con Carne avec Riz':{ type_lunch:'déjeuner',taste:'salée',number_people:'4'},
    'Salade de Pâtes aux Légumes Grillés':{ type_lunch:'dîner',taste:'salée',number_people:'4'},
    'Soupe de Lentilles et Saucisse ':{ type_lunch:'dîner',taste:'salée',number_people:'4'},
    'Sandwich au Saumon Fumé et Fromage Frais':{ type_lunch:'déjeuner',taste:'salée',number_people:'4'},
    'Salade Caprese':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
    'Crêpes à la Confiture de Fraises':{ type_lunch:'goûter',taste:'salée',number_people:'4'},
    'Gaufres aux Fruits et Crème Chantilly':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
    'Tartelettes aux Fruits de Saison ':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
    'Pancakes aux Myrtilles et Sirop d\'Érable':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
    'Pudding au Pain et aux Raisins Secs':{ type_lunch:'goûter',taste:'salée',number_people:'4'},
    'Brownies aux Noix et au Chocolat ':{ type_lunch:'goûter',taste:'salée',number_people:'4'},
    'Muffins aux Pépites de Chocolat ':{ type_lunch:'goûter',taste:'salée',number_people:'4'},
    'Tarte aux Pommes Maison':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
    'Crumble aux Fruits Rouges ':{ type_lunch:'goûter',taste:'salée',number_people:'4'},
    'Mousse au Chocolat':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
    'Tiramisu':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
    'Cheesecake aux Fruits Rouges ':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
    'Tarte Tatin aux Pommes':{ type_lunch:'goûter',taste:'salée',number_people:'4'},
    'Panna Cotta à la Vanille':{ type_lunch:'dpetit-déjeuner',taste:'salée',number_people:'4'},
    'Coulant au Chocolat':{ type_lunch:'goûter',taste:'salée',number_people:'4'},
    'Salade de Fruits Frais':{ type_lunch:'petit-déjeuner',taste:'salée',number_people:'4'},
  }
  ...
  const recipes = {
    ...
    'Roulés de Courgettes au Fromage de Chèvre':{ steps:'dîner'},
    'Club Sandwich au Poulet et au Bacon':{ steps:'dîner'},
    'Gnocchis à la Sauce Tomate et Basilic':{ steps:'dîner'},
    'Chili Con Carne avec Riz':{ steps:'dîner'},
    'Salade de Pâtes aux Légumes Grillés':{ steps:'dîner'},
    'Soupe de Lentilles et Saucisse':{ steps:'dîner'},
    'Sandwich au Saumon Fumé et Fromage Frais':{ steps:'dîner'},
    'Salade Caprese':{ steps:'dîner'},
    'Crêpes à la Confiture de Fraises':{ steps:'dîner'},
    'Gaufres aux Fruits et Crème Chantilly':{ steps:'dîner'},
    'Tartelettes aux Fruits de Saison ':{ steps:'dîner'},
    'Pancakes aux Myrtilles et Sirop d\'Érable':{ steps:'dîner'},
    'Pudding au Pain et aux Raisins Secs':{ steps:'dîner'},
    'Brownies aux Noix et au Chocolat ':{ steps:'dîner'},
    'Muffins aux Pépites de Chocolat ':{ steps:'dîner'},
    'Tarte aux Pommes Maison':{ steps:'dîner'},
    'Crumble aux Fruits Rouges ':{ steps:'dîner'},
    'Mousse au Chocolat':{ steps:'dîner'},
    'Tiramisu':{ steps:'dîner'},
    'Cheesecake aux Fruits Rouges ':{ steps:'dîner'},
    'Tarte Tatin aux Pommes':{ steps:'dîner'},
    'Panna Cotta à la Vanille':{ steps:'dîner'},
    'Coulant au Chocolat':{ steps:'dîner'},
    'Salade de Fruits Frais':{ steps:'dîner'},
  }
